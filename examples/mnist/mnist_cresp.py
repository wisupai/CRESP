...
def prepare_data_loaders():
    ...
    train_loader = DataLoader(train_dataset, batch_size=64, shuffle=True, **dataloader_kwargs)

    test_loader = DataLoader(test_dataset, batch_size=1000, shuffle=False, **dataloader_kwargs)
    ...
    try:
        ...
        if workflow.mode == "experiment":
            ...
            if "generate_report" in results and results["generate_report"]:
                print(
                    f"Report generated at (from run): {results['generate_report'].get('report_path', 'N/A')}"
                )
